...
// const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/scientiapf`, {
...
let sequelize =
  process.env.NODE_ENV === "production"
    ...
    : new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/scientiapf`, {
      logging: false, // set to console.log to see the raw SQL queries
      native: false, // lets Sequelize know we can use pg-native for ~30% more speed
    });
...
const { Course, User, Review, Category, Order, Bought_course, Gift } = sequelize.models;
